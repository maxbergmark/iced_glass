...
impl Ui {
    ...
    fn image(&self) -> Element<'_, Message> {
        container(column![
            row![
                image("examples/group_container/assets/ship.jpg")
                    .width(Length::FillPortion(1))
                    .height(Length::FillPortion(1)),
                image("examples/group_container/assets/black_white.jpg")
                    .width(Length::FillPortion(1))
                    .height(Length::FillPortion(1))
            ],
            row![
                image("examples/group_container/assets/nature.jpg")
                    .width(Length::FillPortion(1))
                    .height(Length::FillPortion(1)),
                image("examples/group_container/assets/flowers.jpg")
                    .width(Length::FillPortion(1))
                    .height(Length::FillPortion(1))
            ]
        ])
